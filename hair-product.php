...
if(isset($_GET['search']) && $_GET['search'] != ""){
    ...
    $sql = "SELECT * FROM products 
            WHERE product_category = 'hair product'
            AND (
    ...
    $sql = "SELECT * FROM products WHERE product_category = 'hair product'";
    ...
    <div class="row">
      ...
      <div class="col-lg-2 mb-4">
        ...
        <ul class="list-unstyled">
          ...
          <li><a href="hair-product.php" class="text-light text-decoration-none">Products</a></li>
