...
echo "<div class='container text-center'>
       <div class='row mt-3 g-5 align-items-stretch'>";
...
<div class='card h-100'>
  ...
  <div class='card-body d-flex flex-column'>
    ...
    <h5>$" . $row['price'] . "</h5>
<a href='product-detail.php?id=" . $row['id'] . "' class='btn btn-brand'>View details</a>
  </div>
</div>
</div>";
...
echo "<div class='col-12 text-center py-5'>
        ...
        <p class='text-muted'>Try searching another product.</p>
      </div>";
    ...
    <div class="row">
      ...
      <div class="col-lg-2 mb-4">
        ...
        <ul class="list-unstyled">
          ...
          <li><a href="make-up.php" class="text-light text-decoration-none">Products</a></li>
