...
<div class="update-wrapper">
    ...
    <a href="admin/display.php" class="back-link">
    ...
    <div class="card-modern">
        <div class="card-header-modern">
            ...
            <span class="card-title-modern">Update product</span>
        </div>
...
if(isset($_POST['submit'])){
    ...
    img= '$img', product_category= '$product_category', product_name ='$product_name' , description = '$description', price = '$price' where id= '$id'";
